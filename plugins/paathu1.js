...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'paathu ?(.*)', fromMe: true, desc: Lang.BOT_DESC}, async (message, match) => {
    ...
    Asena.addCommand({pattern: 'paathu ?(.*)', fromMe: false, desc: Lang.BOT_DESC}, async (message, match) => {
